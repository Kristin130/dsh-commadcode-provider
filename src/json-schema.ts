/**
 * Tool parameter normalization: convert any legacy pi-style schema shape into
 * JSON Schema before it is sent to the Command Code API. Ported verbatim from
 * pi-commandcode-provider's `src/json-schema.ts`.
 *
 * @module dsh-commandcode-provider/json-schema
 */
