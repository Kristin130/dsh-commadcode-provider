/**
 * Secret redaction and context-overflow normalization for Command Code
 * errors. Ported from pi-commandcode-provider's `src/overflow.ts`.
 *
 * @module dsh-commandcode-provider/overflow
 */
...
/** Redact credentials that could leak into logs or user-visible diagnostics. */
...
/** Extract a redacted human message from an arbitrary provider error payload. */
...
/** Whether an error message is a Command Code context overflow (after redaction). */
...
/** Normalize an assistant error message for the Command Code provider only. */
